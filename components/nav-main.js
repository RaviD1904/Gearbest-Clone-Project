...
const navMain = () => {
  ...
  <div id="navSearch">
      <div id="topDropdown">
          ...
          <div id="support">
              <a href="/dummy.html">
                  <p class="pTag">Support Center</p>
              </a>
          </div>
          <div id="shipTo">
              <p class="pTag">Ship to</p>
              <img id="usaFlag"
                  src="https://cdn3.iconfinder.com/data/icons/all-national-flags-of-the-world-very-high-quality/283/usa-512.png"
                  alt="" />
          ...
          <div id="countryDropDown">
              <div id="country">
                  <p class="pTag">Country Website</p>
                  <div class="arrowDiv">
                      <img class="downArrow"
                          src="https://icons.veryicon.com/png/o/internet--web/prejudice/down-arrow-5.png"
                          alt="" />
      ...
      <div id="navSignin">
          <div id="searchBar">
              ...
              <div id="sBarRight">
                  <button id="sButton">
                      <img id="searchGlass"
                          src="https://www.kindacode.com/wp-content/uploads/2020/12/search.png" alt="" />
                  </button>
              </div>
          </div>
          <div id="navHead">
