import necklaceData from "../allData/necklaceData.js";
import footer from "../components/footer.js";
document.querySelector(".footer").innerHTML=footer();

const container = document.querySelector(".container");

appendData(necklaceData);

const wishedArr = JSON.parse(localStorage.getItem("wishedItem")) || [];

function appendData(necklaceData) {
  // console.log("insideFun");
  container.innerHTML = null;
  necklaceData.forEach((el) => {
...
function sortByHottest() {
  necklaceData.sort(function (a, b) {
